...
var argv, connect, counter, dgram, error_handler, fs, gauge, getStore, http, http_handlers, initStores, lss, startHTTP, startUDP, stores, udp_handlers, url;
...
initStores = function(filename) {
  ...
  return fs.readFile(filename, 'utf8', function(err, data) {
    ...
    for (key in data) {
      value = data[key];
      store = getStore(key);
      _results.push(store.load(value));
    }
    return _results;
  });
};
